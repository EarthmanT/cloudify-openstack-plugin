...
class TestSecureClientConfig(testtools.TestCase):
    ...
    def test_update_config_with_secrets(self):
        ...
        expected = \
            ctx.node.properties['controller_config']['secret_schemas']['aws_config']['secret_names']
        self.assertEquals(
            ctlr_cfg.update_config_with_secrets(aws_config, 'aws_config'),
            expected
        )
        expected = \
            ctx.node.properties['controller_config']['secret_schemas']['azure_config']['secret_names']
        self.assertEquals(
            ctlr_cfg.update_config_with_secrets(azure_config, 'azure'),
            expected
